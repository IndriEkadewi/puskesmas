        ...
        <?php foreach ($poli as $poli) { ?>
          <div class="col-md-2 col-md-3 mb-4">
            <div class="thumbnail" style="height: 370px;">
              <img src="<?= base_url('assets/img/upload/') . $poli->image; ?>" style="max-width:100%; max-height: 100%; height: 200px; width: 180px;">
              <div class="caption">
                <h5 class="mt-2" style="min-height: 30px"><?= $poli->nama_poli ?></h5>
                <p>
                  <?php if ($poli->stok < 1) { ?>
